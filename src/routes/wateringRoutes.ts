...
import { validateWateringSchedule, validateDateRange } from '../middleware/wateringValidation';
...
router.get(
    '/today',
    wateringController.getTodaySchedules
);
...
router.put(
    '/schedule/:id/status',
    wateringController.updateScheduleStatus
);
